...
cyberhuatuo launch-assets --username your-github-username --framework langchain --release-tag v0.2.0 --target-contributors 3
...
python scripts/check_marketplace_release.py --remote --strict-remote --username your-github-username --framework langchain --release-tag v0.2.0 --target-contributors 3
```
