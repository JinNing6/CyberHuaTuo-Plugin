...
REQUIRED_WHEEL_MEMBERS = (
    ...
    "cyberhuatuo/case_taxonomy.py",
    "cyberhuatuo/cases/general-ai/data-and-serialization/jsonl-bom-001.md",
    "cyberhuatuo/cases/mcp/agent-and-tooling/daemon-runtime-state-005.md",
    "cyberhuatuo/guard_report.py",
    "cyberhuatuo/cli.py",
    "cyberhuatuo/install.py",
    "cyberhuatuo/marketplace.py",
    "cyberhuatuo/mcp_server.py",
    "cyberhuatuo/schema/case.schema.json",
...
REQUIRED_SDIST_MEMBERS = (
    ...
    ".github/ISSUE_TEMPLATE/guard-false-negative.yml",
    ".github/ISSUE_TEMPLATE/guard-false-positive.yml",
    ".github/ISSUE_TEMPLATE/guard-integration-gap.yml",
    ...
    "docs/prescription-classification.md",
    "cases/general-ai/data-and-serialization/jsonl-bom-001.md",
    "cases/mcp/agent-and-tooling/daemon-runtime-state-005.md",
    "cyberhuatuo/activation.py",
    "cyberhuatuo/agent_guard.py",
    "cyberhuatuo/agent_hook.py",
    "cyberhuatuo/guard_report.py",
...
REQUIRED_SDIST_TEXT_SNIPPETS = {
    ...
    "SECURITY.md": (
        ...
        "Do not execute a destructive command solely",
    ),
    "hooks/hooks.json": (
        "PreToolUse",
        "pre_tool_guard.py",
