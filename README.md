...
The best route is agent-native: connect CyberHuaTuo MCP once, then let the agent call `diagnose` when it fails. After the fix works, keep the cure with `save_prescription`, or publish it with `upload_prescription` when `GITHUB_TOKEN` is configured.
...
**60-second start (available in `0.2.3`):**
...
cyberhuatuo traction-proof --username your-github-username --framework langchain --release-tag v0.2.3 --target-contributors 3 --record-snapshot
python -m cyberhuatuo candidate-install-smoke --username your-github-username --framework langchain --release-tag v0.2.3 --target-contributors 3
cyberhuatuo market-copy --username your-github-username --framework langchain --release-tag v0.2.3 --target-contributors 3
cyberhuatuo record-market --username your-github-username --framework langchain --channel pypi --status submitted --submission-url <reviewable public URL> --release-tag v0.2.3
cyberhuatuo market-status --username your-github-username --framework langchain --release-tag v0.2.3
cyberhuatuo first-invite --username your-github-username --invitee external-contributor-github-username --framework langchain --release-tag v0.2.3 --target-contributors 3 --source-url https://github.com/JinNing6/CyberHuaTuo-Plugin/issues/123
...
```bash
# Install
python -m pip install --upgrade "cyberhuatuo @ git+https://github.com/JinNing6/CyberHuaTuo-Plugin.git@v0.2.3"
python -m pip install --upgrade cyberhuatuo  # after PyPI latest matches v0.2.3
...
- **Claude markets**: ship Claude Code through `.claude-plugin/plugin.json` and `.claude-plugin/marketplace.json`, submit to `claude-community` after `claude plugin validate .`, then package Claude Desktop through `claude-desktop/manifest.json` plus `.github/workflows/package-claude-mcpb.yml` for MCPB / Connectors Directory submission.
...
> 💡 **Your first step**: [Submit a Prescription →](https://github.com/JinNing6/CyberHuaTuo-Plugin/issues/new?template=soul-ring-prescription.yml)
>
> 💡 **你的第一步**: [提交你的第一份药方 →](https://github.com/JinNing6/CyberHuaTuo-Plugin/issues/new?template=soul-ring-prescription.yml)
...
|:----:|:------:|:----:|:------------:|:-------------------:|
| 🥇 | <a href="https://github.com/CyberHuaTuo"><img src="https://github.com/CyberHuaTuo.png" width="50" height="50" style="border-radius:50%"/></a> | [@CyberHuaTuo](https://github.com/CyberHuaTuo) | 🩺 华佗再世 Hua Tuo Reborn | 35 |
...
> [Submit a prescription](https://github.com/JinNing6/CyberHuaTuo-Plugin/issues/new?template=soul-ring-prescription.yml), [open a PR](https://github.com/JinNing6/CyberHuaTuo-Plugin/pulls), or [contribute a case](https://github.com/JinNing6/CyberHuaTuo-Plugin/issues/new) — every contribution counts!
>
> **想在这里看到你的头像？**
...
<p align="center">
  ...
  <a href="https://github.com/JinNing6/CyberHuaTuo-Plugin/issues/new?template=soul-ring-prescription.yml">💊 Submit Your First Prescription — 提交你的第一份药方</a>
  <br>
